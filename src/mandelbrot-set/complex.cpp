...
#include "src/mandelbrot-set/complex.h"
 ...
 * */
void Complex::setReal(double real) { this->m_real = real; }

/** Sets the imaginary part of the complex number.
 *
 * @param imag The number to set the imaginary part to.
 * */
void Complex::setImag(double imag) { this->m_imag = imag; }
 ...
 * */
double Complex::getReal(void) const { return this->m_real; }

/** Gets the imaginary part of the complex number.
 *
 * @return The imaginary part of the complex number.
 * */
double Complex::getImag(void) const { return this->m_imag; }
...
void Complex::inv(void) {
  double denominator =
      this->getReal() * this->getReal() + this->getImag() * this->getImag();
...
void Complex::square(void) { this->mult(*this); }
...
void Complex::print(void) { std::cout << *this << std::endl; }
...
void testComplexClass(void) {
  ...
  // Testing getters
  std::cout << "New c1: " << c1.getReal() << " + j" << c1.getImag()
            << std::endl;
  std::cout << "In Polar: (" << c1.abs() << ", " << c1.phase() << ")"
            << std::endl;
  std::cout << "Conjugate: ";
  c1.conjugate().print();
